...
class OnboardingGoalPage extends StatefulWidget {
  const OnboardingGoalPage({super.key, required this.onContinue});
      ...
      children: [
        Row(
          children: [
            ...
            const Expanded(
              child: OnboardingProgressBar(currentStep: 2, totalSteps: 4),
            ),
        ...
        AstraButton(
          ...
          onPressed: state.isGoalValid ? widget.onContinue : null,
        ),
        const SizedBox(height: AstraSpacing.kSpaceMd),
        AstraButton(
          label: 'Skip',
          ...
          onPressed: () {
            cubit.setGoalInput('$kDefaultStepGoal');
            widget.onContinue();
          },
        ),
      ],
