...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get myDataFieldLogExportSaved => 'Journal de diagnostic enregistré';

  @override
  String get myDataFieldLogExportSemantics =>
      'Exporter le journal de diagnostic d\'arrière-plan';
  ...
  @override
  String get todayWeekDayGoalNotMet => 'objectif non atteint';
  ...
  String get todayActivityStatsSemanticsEmpty =>
      'Statistiques d\'activité : aucune activité pour l\'instant';
  ...
  String chartMonthlySelectionSemantics(
    ...
    return '$month, $avgSteps pas/jour, $total au total · $days jours';
  }
