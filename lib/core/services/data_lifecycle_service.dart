...
/// Outcome of [runMaintenanceOnConnection]: skipped when not due, or downsampling plus optimize/VACUUM ran.
...
///
/// Phase 0 scheduling: Android weekly WorkManager; iOS opportunistic maintenance
/// via My Data / foreground isolate offload only — not on app resume (resume must
/// not VACUUM while UI DB is open).
///
