# Audits données & pipeline — index

**Campagne :** data-pipeline · Epics 29–33 · voir aussi [index audits](../README.md)
...
Ce dossier complète [post-refacto/](../post-refacto/README.md) (Epics 21–28, UI/runtime) avec une analyse **granulaire du pipeline données** : chemins de fichiers, numéros de lignes, scénarios de failure, todos consolidées et liens croisés entre diagnostics.
...
|-------|---------------|-----------------|-----------|
| `withRetry` / `database_closed` | `fixed` — `busy_timeout` 5000 ms (30-2) | UI offload VACUUM OK ; WM vs WM gap | [diagnostic-acces-concurrents.md](../post-refacto/diagnostic-acces-concurrents.md) E21 done |
...
|-------|----------|-----------|
| Permission fragmentée Today | **02** | [diagnostic-gestion-etat-erreur.md](../post-refacto/diagnostic-gestion-etat-erreur.md) — E28 backlog |
...
*(Epics 29–33 clos — voir [`epics.md`](../../epics.md). Epics 21–28 (post-refacto) : **done** — [`post-refacto/README.md`](../post-refacto/README.md).)*
...
| Document | Rôle |
|----------|------|
| [`../README.md`](../README.md) | Index audits (master) |
| [`../post-refacto/README.md`](../post-refacto/README.md) | Post-refacto (Epics 21–28) |
| [`epics.md`](../../epics.md) | Acceptance criteria Epics 1–33 |
